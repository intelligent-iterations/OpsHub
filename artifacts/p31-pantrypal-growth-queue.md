...
- [ ] PP-GROWTH-002-rescue-streak-comeback-experiment-for-lapsed-households — Rescue streak comeback experiment for lapsed households (score: 79.75, owner: growth-oncall)
  - Acceptance criteria:
    ...
    - [ ] Decision log is updated with launch date, owner, and rollback trigger.
- [ ] PP-GROWTH-003-smart-defrost-reminder-timing-tuned-by-prep-time-tier — Smart defrost reminder timing tuned by prep-time tier (score: 77.60, owner: growth-oncall)
  - Acceptance criteria:
...
Readiness: 100%
Top blockers: none
Score summary: avg 79.37, median 79.75, min 77.6, max 80.75
Score by readiness: ready avg 79.37, blocked avg 0
...
Owner load: growth-oncall total 3 (ready 3, blocked 0, avg 79.37)
